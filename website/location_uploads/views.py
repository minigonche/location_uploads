...
def index(request):
	...
	survey_urls = ps.get_survey_urls()
	json_urls = ps.get_json_urls()


	data['survey_link'] = random.choice(survey_urls)
	data['json_link'] = random.choice(json_urls)

	return render(request, 'location_uploads/index.html', data)

def survey(request):
	data = {}
	return render(request, 'location_uploads/survey.html', data)

def jsons(request):
	data = {}
	return render(request, 'location_uploads/jsons.html', data)

def terms(request):
	data = {}
	return render(request, 'location_uploads/terms.html', data)
